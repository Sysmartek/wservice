	...
	protected void doGet(HttpServletRequest request,
		...
		if (cartBean1 == null) {
			...
			try {
				...
				//String jndi_Name = "java:global/CartEJBRemote";
...
//				
				...
				cartBean2 = (CartRemote) ic.lookup("java:jboss/exported/wservices-ear/wservices-server-1/CartEJBRemote!com.martini.enterprise.ejb.CartRemote");
				//cartBean2 = (CartRemote) ic.lookup("java:global/wservices-ear/wservices-server-1/CartEJBRemote!com.martini.enterprise.ejb.CartRemote");
				
				//cartBean1 = cartRemote;
				cartBean1 = (CartRemote) ic.lookup("java:global/wservices-ear/wservices-server-1/CartEJBRemote!com.martini.enterprise.ejb.CartRemote");
				
//				cartBean2 = (CartRemote) ic.lookup("CartEJBRemote");
